                ...
                <div className="sns-wrapper">
                    ...
                    <div className="sns-link">
                        ...
                        <Link href={"https://www.youtube.com/@NVP-lh3op"} target="_blank">
                            <img src="/images/SNS/youtube.png" alt="Nvp-youtube" className="sns-img" />
                        </Link>
                        <Link href={"https://www.instagram.com/nsu_nvp_volleyball/"} target="_blank">
                            <img src="/images/SNS/instagram.png" alt="Nvp-instagram" className="sns-img" />
                        </Link>

                        <img src="/images/SNS/NvpLogo.png" alt="Nvp-instagram" onClick={handle} className="sns-img" />
